...
map("n", "<c-w>p", "<cmd>Pick diagnostic scope='current'<cr>")
...
map({ "n", "i" }, "<c-t>", "<cmd>silent !tmux neww tmux-sessionizer<cr>")
...
map("n", "<leader>ft", vim.lsp.buf.type_definition)
map("n", "<leader>fwd", vim.lsp.buf.workspace_diagnostics)
map("n", "<leader>fws", vim.lsp.buf.workspace_symbol)
map("n", "<leader>fst", function()
